...
impl GpuComputePipeline {
    pub fn new(device: Arc<Device>, queue: Arc<Queue>) -> Self {
        ...
        // Initial buffer sizes; sparse path resizes via ensure_output_buffer_size before use
        let (params_buffer, moulds_buffer, profile_data_buffer, counters_buffer,
             vertices_buffer, indices_buffer,
             counters_staging, vertices_staging, indices_staging) =
            Self::create_buffers(&device, 64u32);
    ...
    fn create_buffers(
        ...
        // Initial small sizes; sparse path resizes via ensure_output_buffer_size before use
        let max_vertices = 1024usize;
        ...
        (params_buffer, moulds_buffer, profile_data_buffer, counters_buffer,
         vertices_buffer, indices_buffer,
         counters_staging, vertices_staging, indices_staging)
    }
